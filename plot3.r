...
png("plot3.png")
with(data, plot(timestamp, as.numeric(Sub_metering_1), type = "l", xlab="", ylab="Energy sub metering"))
with(data, lines(timestamp,as.numeric(Sub_metering_2), col="red"))
with(data, lines(timestamp,as.numeric(Sub_metering_3), col="blue"))
